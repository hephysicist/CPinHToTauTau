...
"""
Producers for the TauTheDifference BDT for signal vs. background separation of the MSSM analysis.
"""
import law
import os
import sys 
...
@producer(
    uses={
        "event",
        "hcand*", "PuppiMET*", "PuppiMET.covXX", "PuppiMET.covXY", "PuppiMET.covYY"
    },
    produces = {"hcand*"}
)
def fast_mtt(

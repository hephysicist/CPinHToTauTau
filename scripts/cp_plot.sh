...
args=(
        --configs $configs
        --processes $processes #"$signal_procs_sm,dy_tt_m50,dy_ll_m50,vvt,tt,w,jet_fakes,qcd,data"
        --datasets  $datasets
        --categories "cat_mutau_sr__fake_incl__fake" #cat_mutau_sr__prompt__bdt_hig__cat0__tau2pi

        #cat_mutau_dr_num_wj__fake_incl__bdt_incl,cat_mutau_dr_num_qcd__fake_incl__bdt_incl
        #cat_mutau_dr_num_wj__fake_incl__bdt_incl
        #cat_mutau_ar_yields__fake_incl__bdt_incl
        ...
        --cf.PlotVariables1D-version May13
        --variables bdt_raw_score_4bins_fake
        --blinding-threshold 0.00

        # 'hcand_mutau_fastMTT_mass,mutau_mvis,mutau_lep0_pt,mutau_lep0_eta,mutau_lep1_pt,'`
        # `'mutau_lep1_eta,mutau_pt_vis_coarse,puppi_met_pt_coarse'


        #'hcand_mutau_fastMTT_mass,mutau_mvis,bdt_raw_score_gtau,bdt_raw_score_higgs,bdt_raw_score_fake'
                #mutau_lep0_eta,mutau_lep0_phi,mutau_lep0_mass,mutau_lep0_iso,'`
                ...
                #`'mutau_mvis,mutau_mt,mutau_delta_r,mutau_pt_vis,leading_jet_pt,subleading_jet_pt,n_jets,puppi_met_pt,puppi_met_phi,'`
        ...
        #--process-settings 'h_ggf_htt_sm_prod_sm,unstack,scale=stack,color=#d62839:'`
        #`'h_vbf_htt_sm,unstack,scale=stack,color=#2ca02c'
        
        #'h_ggf_htt_cpo_prod_sm,unstack,scale=stack,color=#28348e:'`
        #`'h_ggf_htt_mm_prod_sm,unstack,scale=stack,color=#2b663c:'`
      
        #`'h_vbf_htt_cpo,unstack,scale=stack,color=#1f77b4:'`
        #`'h_vbf_htt_mm,unstack,scale=stack,color=#ff7f0e:'`
        ...
        --hist-hooks ff_method,order #ff_method_dr_closure_test,qcd,incl,ff_method
       ...
       #--process-settings "h_ggf_htt_cpo_prod_sm,unstack,scale=stack,color=#28348e:h_ggf_htt_mm_prod_sm,unstack,scale=stack,color=#2b663c:h_ggf_htt_sm_prod_sm,unstack,scale=stack,color=#d62839:h_vbf_htt_cpo,unstack,scale=stack,color=#3B82F6:h_vbf_htt_sm,unstack,scale=stack,color=#FB7185:h_vbf_htt_mm,unstack,scale=stack,color=#22C55E"
       --process-settings "h_ggf_htt_cpo_prod_sm,unstack,scale=1,color=#28348e:h_ggf_htt_mm_prod_sm,unstack,scale=1,color=#2b663c:h_ggf_htt_sm_prod_sm,unstack,scale=1,color=#d62839:h_vbf_htt_cpo,unstack,scale=1,color=#3B82F6:h_vbf_htt_sm,unstack,scale=1,color=#FB7185:h_vbf_htt_mm,unstack,scale=1,color=#22C55E"
        "${@:2}"
    )

...
variables_emu_list=("D_zeta"
#   "emu_mt_tot_fit" "emu_mt_tot" "emu_mt_emu" "D_zeta"
...
################################
    ...
    "run3_2022preEE_emu_lim")
        ...
        datasets=$bkg_SM_higgs,$bkg_vh_htt,$bkg_ewk,$bkg_single_top,$bkg_ttbar,$data
        processes='SM_higgs,vh_htt,dy_ll,dy_tautau,w_lnu,vv,vvv,st,tt,h_ggf_htt_masses,bbh_htt_masses,data'
...
#########################        
    ...
    "run3_2022preEE_emu_SM_Higgs")
        ...
        datasets='VBFHto2Tau_UncorrelatedDecay_UnFiltered,GluGluHto2Tau_UncorrelatedDecay_SM_UnFiltered_ProdAndDecay,'
	      ...
	      workflow='local'
    ;;
    "run3_2022preEE_emu_dy_tautau")
        config="run3_2022_preEE_emu_limited"
        processes='dy,dy_tautau_nj,'
        #'dy_m10to50,dy_m50toinf_0j,dy_m50toinf_1j,dy_m50toinf_2j,dy_m50toinf,dy_tautau_m50toinf_0j,dy_tautau_m50toinf_1j,dy_tautau_m50toinf_2j'
